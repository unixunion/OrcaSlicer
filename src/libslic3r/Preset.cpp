...
static std::vector<std::string> s_Preset_print_options {
    ...
    "ooze_prevention", "standby_temperature_delta", "preheat_time","preheat_steps", "idle_timeout", "cold_preheat_time", "interface_shells", "line_width", "initial_layer_line_width", "inner_wall_line_width",
...
static std::vector<std::string> s_Preset_printer_options {
    ...
    "silent_mode",
    "scan_first_layer", "enable_power_loss_recovery", "wrapping_detection_layers", "wrapping_exclude_area", "machine_load_filament_time", "machine_unload_filament_time", "machine_tool_change_time", "disable_heater_after_last_use", "time_cost", "machine_pause_gcode", "template_custom_gcode",
